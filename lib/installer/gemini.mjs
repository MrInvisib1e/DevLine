...
export async function installGemini({ dryRun = false, homeDir, log } = {}) {
  ...
  const block = `\n<!-- devline-start -->\n# devline\nDevline skills are available from the @devline/cli package.\nInstall: npm install -g @devline/cli\n<!-- /devline-start -->\n`;
  ...
  logger.warn('Gemini CLI extensions require @devline/cli to be published on npm.');
}
